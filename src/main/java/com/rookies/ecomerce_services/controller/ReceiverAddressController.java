...
public class ReceiverAddressController {
    ...
    public ApiResponse<List<ReceiverAddressResponse>> getReceiverAddressByUserId(@PathVariable Long customerId) {
        return ApiResponse.<List<ReceiverAddressResponse>>builder()
                .code(HttpStatus.OK.value())
                .message("Lấy thông tin địa chỉ nhận hàng thành công!")
                .data(receiverAddressService.getReceiverAddressByCustomer(customerId))
                .build();
    }
    @PutMapping("/{id}")
    ...
    public ApiResponse<ReceiverAddressResponse> getDefaultReceiverAddress(@PathVariable Long customerId) {
        return ApiResponse.<ReceiverAddressResponse>builder()
                .code(HttpStatus.OK.value())
                .message("Lấy địa chỉ nhận hàng mặc định thành công!")
                .data(receiverAddressService.getDefaultReceiverAddressResponse(customerId))
                .build();
    }
